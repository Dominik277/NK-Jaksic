...
import kotlinx.android.synthetic.main.jedan_red_tablica.view.tablica_pozicija
import kotlinx.android.synthetic.main.pokus_jedan_red_tablica.view.*

class PokusTablicaAdapter (private val sveTabliceUBazi: List<TablicaTablica>) : RecyclerView.Adapter<PokusTablicaAdapter.ViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.pokus_jedan_red_tablica, parent, false)
