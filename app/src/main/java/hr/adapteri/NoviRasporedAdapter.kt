...
import kotlinx.android.synthetic.main.jedan_red_tablica_raspored_novi.view.*
...
class NoviRasporedAdapter(private val sviNoviRasporediUBazi: List<TablicaRaspored>): RecyclerView.Adapter<NoviRasporedAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoviRasporedAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.jedan_red_tablica_raspored_novi, parent, false)
        return NoviRasporedAdapter.ViewHolder(view)
    }
