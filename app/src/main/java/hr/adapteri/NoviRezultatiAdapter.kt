...
import kotlinx.android.synthetic.main.jedan_red_tablica_raspored.view.tv_brojKola
import kotlinx.android.synthetic.main.jedan_red_tablica_raspored.view.tv_cetvrtaUtakmica_datum
import kotlinx.android.synthetic.main.novi_red_rezultati.view.*

class NoviRezultatiAdapter(private val sviNoviRezultatiUBazi: List<NoviRezultati>): RecyclerView.Adapter<NoviRezultatiAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.novi_red_rezultati, parent, false)
