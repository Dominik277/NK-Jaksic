...
/*
        ...
        database.rasporedDao().insertRaspored(Raspored(4,"20.03","NK Jakšić-NK Mihaljevci"))
        database.rasporedDao().insertRaspored(Raspored(5,"24.03","NK Jakšić-NK Buk"))
        database.rasporedDao().insertRaspored(Raspored(6,"28.03","NK Jakšić-NK Kutjevo"))
        database.rasporedDao().insertRaspored(Raspored(7,"14.04","NK Jakšić-NK Slavija"))
        database.rasporedDao().insertRaspored(Raspored(8,"20.04","NK Jakšić-NK Slavonija"))
        database.rasporedDao().insertRaspored(Raspored(9,"24.04","NK Jakšić-NK Zagrađe"))
        database.rasporedDao().insertRaspored(Raspored(10,"29.04","NK Jakšić-NK Bučje"))
*/
