...
/*
        ...
        database.rezultatiDao().insertRezultat(Rezultat(4,"29.02.","NK Jakšić-NK Vidovci","0:1","I"))
        database.rezultatiDao().insertRezultat(Rezultat(5,"02.03.","NK Jakšić-NK Požega","0:1","I"))
*/
